...
module.exports.handleEvent = async function ({ api, event, client, __GLOBAL }) {
  ...
  try {
    if (dipto.startsWith('https://vt.tiktok.com') || dipto.startsWith('https://www.instagram.com/') || dipto.startsWith('https://youtu.be/') || dipto.startsWith('https://youtube.com/') || dipto.startsWith('https://x.com/') || dipto.startsWith('https://twitter.com/') || dipto.startsWith('https://vm.tiktok.com') || dipto.startsWith('https://www.capcut.com')) {
